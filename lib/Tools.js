      ...
      getTimeFromMS(ms) {
         ...
         if (useDDMMYYYFormat) {
            return {
               ...
               ms,
               toString() {
                  return `${year}:${month}:${days}|${hr}:${min}:${sec}.${Math.round(ms).toString().padStart(3, '0')}`;
               },
               modern() {
                  if (year + month + days + sec + min + hr == 0)
                     return `${Tools.maxFraction(ms, 4)}ms`;
                  else if (year + month + days + min + hr == 0)
                     return `${sec}.${Math.round(ms).toString().padStart(3, '0')}s`;
         ...
         return {
            ...
            ms,
            toString() {
               return `${hr}:${min}:${sec}.${Math.round(ms).toString().padStart(3, '0')}`;
            },
            modern() {
               if (sec + min + hr == 0) return `${Tools.maxFraction(ms, 4)}ms`;
               else if (min + hr == 0)
                  return `${sec}.${Math.round(ms).toString().padStart(3, '0')}s`;
